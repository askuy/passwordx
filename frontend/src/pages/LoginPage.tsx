    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8 animate-fade-in">
          ...
          <p className="text-dark-400">Sign in to access your passwords</p>
        </div>
        ...
        <div className="glass rounded-2xl p-8 glow animate-fade-in" style={{ animationDelay: '0.1s' }}>
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              className="w-full py-3 bg-primary-600 text-white rounded-xl hover:bg-primary-500 transition-colors font-semibold disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="flex items-center justify-center gap-2 py-3 bg-dark-800 border border-dark-700 rounded-xl hover:bg-dark-700 transition-colors text-dark-300 font-medium"
            >
